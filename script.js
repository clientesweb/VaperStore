...
const products = {
    ...
    vapes_desechables: [
        { id: 7, name: "IGNITE V8", price: 22000, image: "img/ignitvev8.jpg", description: "El V8 Vape cuenta con nuevo hardware y tecnología para brindar el suave sabor y la experiencia del vapor. Solo inhala para encender tu dispositivo precargado. La batería de 500 mAh ofrece un sabor delicioso y jugoso con más de 800 PUFF, suficiente para mantenerte satisfecho todo el día y más." },
        { id: 8, name: "IGNITE V50", price: 28000, image: "img/ignitev50.jpg", description: "Dispositivo desechable no requiere rellenado. Batería interna recargable: 500 mAh (cable micro USB-C no incluido). Precargado, simplemente sopla el dispositivo para activarlo. 5% (50 mg/mL) de nicotina derivada del tabaco en el interior para una experiencia precisa estilo cigarrillo. Hasta 5000 caladas por desechable, equivalente aproximadamente a 7 paquetes de cigarrillos (20 cigarrillos por paquete). Compacto, ligero, portátil y discreto." },
        { id: 9, name: "IGNITE V150 PREMIUM", price: 35000, image: "img/ignitev150.jpg", description: "Alta Potencia: 5% de nicotina para una experiencia intensa. Duración Extrema: Hasta 15,000 caladas con batería de 650 mAh. Fácil de Usar: Activación y modos Eco/Boost con 3 inhalaciones rápidas. Sabor Excepcional: Mezcla de sandía y fruta del dragón. Listo para Usar: Precargado, portátil y elegante con diseño ergonómico. El compañero ideal para vapeo duradero, potente y sofisticado." },
        { id: 10, name: "LOST MARY MT15000 TURBO", price: 22000, image: "img/maryl.jpg", description: "Duración Extendida: Hasta 15,000 caladas con modo Suave o 7,500 en modo Turbo (22W). Potencia Personalizable: Doble bobina de malla para nubes densas o sesiones prolongadas. Tecnología Avanzada: Pantallas para monitorear batería y e-líquido. Especificaciones: Batería recargable de 600mAh (Tipo-C) y 5% de nicotina (50mg). Vapeo a medida con máxima duración y rendimiento." },
    ],
    resistencias: [
